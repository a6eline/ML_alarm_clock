...
// enum classes (also called scoped enumerations) are strongly typed and strongly scoped.
// class enums dont allow for implicit conversions either
// enum classes dont compare enumerators from different enumerations
